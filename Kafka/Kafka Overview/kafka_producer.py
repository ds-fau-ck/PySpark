...
kafka_config = {
    ...
    'sasl.username': '4MTJOS5G7HKCLY7W',
    'sasl.password': 'jdf/WNotpjtbpOlZbOaAXKwKiVtwSLZEbEg5YN1+3x7JEKpHQKuA0hK+aBqZY1bh'
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-rrzpk0.eastus.aws.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('CLTYBNLBMCYEJ47V', 'J3gjYdknh7u4++fk3BvuGkhbl+hegRLcmArOYINX7vmxzfRPtXQ1KyUUJ2Ga818v')
})
